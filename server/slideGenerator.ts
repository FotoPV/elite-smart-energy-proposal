...
export function generateSlides(data: ProposalData): SlideContent[] {
  ...
  slides.push({
    ...
    content: {
      ...
      backupCapability: data.inverterSizeKw >= 10 ? '3-PHASE BACKUP' : 'SINGLE PHASE BACKUP',
      backupDescription: data.inverterSizeKw >= 10 ? 'Full home backup capability with 3-phase support' : 'Essential circuit backup with automatic switchover',
