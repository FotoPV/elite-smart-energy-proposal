...
const BRAND = {
  iconTransparent: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663031440910/GJRgQViiKCZlLYpq.png",
    ...
    >
      ...
      >
        ...
        >
          ...
          <p style={{ color: "#94A3B8", fontSize: "0.875rem", lineHeight: 1.65, fontFamily: "'Open Sans', 'Open Sans', sans-serif" }}>
